...
const { regenerateDocsWiki, DOCS_KEY } = require('../docs-wiki');
...
<main class="iaw-page iaw-narrow2">
  ...
  router.post('/admin', (req, res) => {
    ...
    if (req.body.regenerate_docs) {
      const docsWiki = db.wikiByKey(DOCS_KEY);
      if (!docsWiki) {
        return instanceAdminPage(req, res, { error: 'No docs wiki found — restart the server to create it.' });
      }
